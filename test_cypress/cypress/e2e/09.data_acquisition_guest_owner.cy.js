...
const test_project_name_suffix = "_DATA_ACQUISITION_GUEST_AS_OWNER";
...
it("should delete the file (D7)", () => {
  openProject(() => {
    ...
    let file_delete_prompt_title = cy
      .get(".v-overlay > .v-overlay__content > .v-sheet")
      .contains("Are you sure you want to delete this data?");
