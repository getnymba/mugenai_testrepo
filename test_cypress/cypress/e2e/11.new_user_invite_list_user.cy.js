...
const test_project_name_suffix = "_NEW_USER_INVITE_LIST_USER_AS_NOT_OWNER";
...
after(() => {
  ...
  const search_field =
    ".v-main > .v-container > .v-row > :nth-child(2).v-col > .v-input > .v-input__control > .v-field > .v-field__field > .v-field__input input";
