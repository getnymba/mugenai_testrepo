...
const test_project_name_suffix = "_HOMEPAGE_USER_AS_NOT_OWNER";
...
it("should Hide target project, H24.Hidden projct list, H25.Click to display the target project. Restore the original list - H23.", () => {
...
it("shuold by Click to view bots in a grid or list - H27", () => {
