...
const test_project_name_suffix = "_HOMEPAGE_GUEST_AS_NOT_OWNER";
...
it("should click to go to chat, H18.Click to go to bot details - H17", () => {
  openProject(() => {
...
it("should hide target project, H24.Hidden project list, H25.Click to display the target project. Restore the original list - H23", () => {
...
it("should click to go to the top of the bot list - H26", () => {
  let bProcessed = false;
